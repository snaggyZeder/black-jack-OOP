...
void Card::print_card() {
  ...
  if (m_rank == CARD_2) cout << 2<<endl;
  else
  if (m_rank == CARD_3) cout << 3 << endl;
  else
  if (m_rank == CARD_4) cout << 4 << endl;
  else
  if (m_rank == CARD_5) cout << 5 << endl;
  else
  if (m_rank == CARD_6) cout << 6 << endl;
  else
  if (m_rank == CARD_7) cout << 7 << endl;
  else
  if (m_rank == CARD_8) cout << 8 << endl;
  else
  if (m_rank == CARD_9) cout << 9 << endl;
  else
  if (m_rank == CARD_10) cout << 10 << endl;
  else
  if (m_rank == CARD_J) cout << 'Ja' << endl;
  else
  if (m_rank == CARD_Q) cout << 'Qu' << endl;
  else
  if (m_rank == CARD_K) cout << 'Ki' << endl;
  else
  if (m_rank == CARD_A) cout << 'A' << endl;
 //вывод масти
